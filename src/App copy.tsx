...
import useGeoLocation from './useGeoLocation';  // Import your useGeoLocation hook
    ...
    <div style={appContainer}>
      ...
      >
        <div style={todoColumn}>
          <MapComponent userLocation={location.loaded ? [parseFloat(location.coordinates.lat), parseFloat(location.coordinates.lng)] : [50.775, 6.083]} />          <main className="container">
            <br />
